...
public class Livro {
    ...
    public String getSituacaoEncontrado() { return situacaoEncontrado; }
    public void setSituacaoEncontrado(String situacaoEncontrado) { this.situacaoEncontrado = situacaoEncontrado; }
